...
class Variant(db.Model):
    ...
    url = db.Column(db.String(255), nullable=True)  # Thêm trường URL mới
    def __repr__(self):
...
class Product(db.Model):
    ...
    sold_quantity = db.Column(db.Integer, default=0)  # Thêm cột số lượng đã bán
    rating = db.Column(db.Float, default=0.0)  # Thêm cột điểm đánh giá
